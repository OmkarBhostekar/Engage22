...
public abstract class Hilt_SavedFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SavedFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SavedFragment_GeneratedInjector) this.generatedComponent()).injectSavedFragment(UnsafeCasts.<SavedFragment>unsafeCast(this));
    }
  }
